...
평가 기준:
- quality_score (0~30): 정보성이 높고 독자에게 실질적 도움이 되면 높은 점수.
  단순 홍보 문구 나열·과장이면 낮은 점수.
  경쟁 서비스를 언급하거나 비교하면 소폭 감점(최대 -5점)하되 FAIL 처리하지 않음.
- safety_status: "PASS" 또는 "FAIL"
  FAIL 조건: 명백한 허위사실 기재, 혐오·음란·폭력 등 심각한 부적절 콘텐츠만 해당.
  경쟁사 언급·비교는 FAIL 사유가 아님.
