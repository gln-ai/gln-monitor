...
def build_weekly_report():
    ...
    <div style="font-family:-apple-system,sans-serif;max-width:680px;margin:auto;padding:24px;background:#fff">
      <div style="background:#130D2A;border-radius:14px;padding:20px 24px;margin-bottom:20px;display:flex;align-items:center;justify-content:space-between">
        <div>
          <div style="font-size:11px;color:#7000FC;font-weight:700;letter-spacing:0.08em;margin-bottom:4px">GLN 주간 모니터링 리포트</div>
          <div style="font-size:20px;font-weight:700;color:#fff">{week_label}</div>
        </div>
        <div style="background:#7000FC;border-radius:10px;padding:10px 16px;text-align:center">
      ...
      <div style="display:flex;gap:10px;margin-bottom:16px">
        <div style="flex:1;background:#F9FAFB;border:1px solid #E5E7EB;border-radius:12px;padding:16px 18px">
        ...
        <div style="flex:1;background:#FEF2F2;border:1px solid #FECACA;border-radius:12px;padding:16px 18px">
        ...
        <div style="flex:1;background:#F5F3FF;border:1px solid #DDD6FE;border-radius:12px;padding:16px 18px">
